...
# Replace project name "Project" with your own project name

pdf( paste( "Project", "_PC", pcx, "_PC", pcy, ".pdf", sep = "") )

# Used ggplot instead of qplot

ggplot( PCAEVEC, aes(x = PCAEVEC[ , pcx + 2 ], y = PCAEVEC[ , pcy + 2 ],))+
    geom_point( color = "#FF33FF" )+
    labs( x = ( paste( "PC", pcx, sep = "" ) ), y = ( paste( "PC", pcy, sep = "" ) ) )+
