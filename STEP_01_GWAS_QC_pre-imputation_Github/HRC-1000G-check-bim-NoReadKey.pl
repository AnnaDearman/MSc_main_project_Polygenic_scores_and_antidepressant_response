...
# Added by ARD to allow absolute path to be used in SNP removal PLINK command
my $filename2 = $bim_file;
$filename2 =~ /(.*)\.bim$/;
my $file_stem2 = $1;
...
#remove SNPs
print SH "$plink --bfile $file_stem2 --exclude $excludefile --make-bed --out $tempfile\n";
